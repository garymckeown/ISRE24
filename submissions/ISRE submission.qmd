...
To upload your submissions, visit the [**SUBMISSION SITE**](https://cmt3.research.microsoft.com/User/Login). Abstracts should be submitted by the first author. Symposia should be submitted by the lead symposia proposer. The submitting author should **create a new CMT account** and use that to submit one submission at most, unless they are submitting a symposia in the role of a dissussant. Once you have created an account, you will be taken to the author console page, where you can enter your submission.
...
We are interested in knowing whether candidates are early career researchers. In order to define that, we have adapted the definition provided by the UK Research Councils to include PhD students. Those criteria refer to :
